...
public class Grafo {
    ...
    private int mCoeficiente[][] = new int[100][100];
    private int mAdyacencia[][] = new int[100][100];
    private int cordeX[] = new int[100];
    private int cordeY[] = new int[100];
    private int nombre[] = new int[100];
    private int enArbol[];
